package com.example.guixy.formwidget.datePicker;
...
import com.example.guixy.formwidget.wheelView.ArrayWheelAdapter;
import com.example.guixy.formwidget.wheelView.OnWheelChangedListener;
import com.example.guixy.formwidget.wheelView.WheelView;
...
public class DatePicker extends AlertDialog implements View.OnClickListener {
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case R.id.dialog_date_choose_cancel:
                cancel();
                break;
            case R.id.dialog_date_choose_sure:
                ...
                dismiss();
                break;
            case R.id.ll_choose_id_long_term:
    ...
    private void changeItem(WheelView wheelView, int newValue) {
        ...
        if (wheelView == monthWheelView) {
            if (newMonth == 2 && isLeapYear(Integer.valueOf(yearParent[newValue]))) {
                mDay = 29;
                refreshDay();

            } else if (newMonth == 2 && !isLeapYear(Integer.valueOf(yearParent[newValue]))) {
                mDay = 28;
                refreshDay();
            }
