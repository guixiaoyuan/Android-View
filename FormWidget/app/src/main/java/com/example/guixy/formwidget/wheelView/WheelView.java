...
public class WheelView extends View {
    ...
    // Items dialog_loading_layout
    private LinearLayout itemsLayout;

    // The number of first item in dialog_loading_layout
     ...
     * Actual amount of visible items depends on wheel dialog_loading_layout parameters.
    ...
    /**
     * Calculates desired height for dialog_loading_layout
     *
     * @param layout the source dialog_loading_layout
     * @return the desired dialog_loading_layout height
     */
     ...
     *
     * @param widthSize the input dialog_loading_layout width
     * @param mode      the dialog_loading_layout mode
     ...
     *
     * @param width  the dialog_loading_layout width
     * @param height the dialog_loading_layout height
     */
    ...
    /**
     * Adds view for item to items dialog_loading_layout
     *
     * @param index the item index
