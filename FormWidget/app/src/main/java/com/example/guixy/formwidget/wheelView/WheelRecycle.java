...
public class WheelRecycle {
    ...
    /**
     * Recycles items from specified dialog_loading_layout.
     * There are saved only items not included to specified range.
     * All the cached items are removed from original dialog_loading_layout.
     *
     * @param layout    the dialog_loading_layout containing items to be cached
     * @param firstItem the number of first item in dialog_loading_layout
